...
const { 
  ...
  // Sync fetched data into local editable form state once it arrives
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await updateCourse(formData, mediaFiles.thumbnail);
      ...
      <div className="max-w-[1000px] mx-auto py-12 px-8 relative z-10">
        ...
        {formData && (
          <form onSubmit={handleSubmit} className="space-y-10">
            <CourseBasicInfo data={formData} onChange={handleCourseDataChange} />
            <CourseMedia
            media={mediaFiles}
